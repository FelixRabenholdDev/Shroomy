...
checkCollisions() {
  this.level.enemies.forEach((enemy) => {
    if (this.character.isColliding(enemy)) {
      ...
      const comingFromAbove = overlap > 0 && overlap < this.character.height * 0.6 && this.character.y < enemy.y && (this.character.speedY <= 0 || this.character.lastSpeedY < 0);
...
*/
checkThrowObjects() {
  if (this.keyboard.D && Date.now() - this.lastThrowTime > 1250 && this.character.mana > 0) {
